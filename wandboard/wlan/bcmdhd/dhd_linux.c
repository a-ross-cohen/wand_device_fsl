 ...
 */
char firmware_path[MOD_PARAM_PATHLEN] = "/system/etc/firmware/brcm/bcm4329_fw.bin";
char nvram_path[MOD_PARAM_PATHLEN] = "/system/etc/firmware/brcm//bcm4329_nvram.txt";
